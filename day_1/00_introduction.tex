...
\begin{itemize}\addtolength{\itemsep}{\baselineskip}
    ...
    \item This course is supported by UExeter's Institute for Data Science and Artificial Intelligence: \href{https://www.exeter.ac.uk/idsai/}{IDSAI}
    \item Big thanks to \href{http://emps.exeter.ac.uk/mathematics/staff/dp457}{Deepak Kumar Panda} for helping out today
\end{itemize}
\vfill
\includegraphics[width=\textwidth, keepaspectratio]{logo.jpg}
...
% TODO  work on refining schedule
    ...
    \begin{itemize}
        \item 900 - 1030: How to run Python
        \item 1030 - 1100: Data types
        \item 1000 - 1010: Break
        \item 1010 - 1030: Data types practical
        \item 1030 - 1100: Flow control
    \end{itemize}
        \item Afternoon session, 1300 - 1600 DDM IT 1.033
    \begin{itemize}
        \item 1300 - 1330: Flow control practical
        \item 1330 - 1400: Functions
