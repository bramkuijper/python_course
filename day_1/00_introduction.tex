...
\column{0.33\textwidth}
    ...
    \begin{minipage}[c][0.2\textheight][c]{\linewidth}
        \footnotesize{Covers Python basics. Good balance between detail and basic introduction. \href{http://do1.dr-chuck.com/pythonlearn/EN_us/pythonlearn.pdf}{Free online}}
    \end{minipage}
    \pause

%2nd column, automate boring stuff
\column{0.33\textwidth}
    \begin{minipage}[c][0.6\textheight][c]{\linewidth}
        \centering
