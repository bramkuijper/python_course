...
%=============================================================================%
%=============================================================================%
%    \item File objects have various member functions such as \href{https://docs.python.org/3/library/io.html#io.TextIOBase.read}{\texttt{read()}, \href{https://docs.python.org/3/library/io.html#io.TextIOBase.write}{\texttt{write()} and \href{https://docs.python.org/3/library/io.html#io.IOBase.close}{close()}
